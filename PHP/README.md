...
Quickly get started with [Unleash SDK](https://github.com/Unleash/unleash-php-sdk) using this starter! Check out [index.php](./index.php) for the code. Set your flag name in line `:30`. Put you instance URL and API client token in `.env`.
